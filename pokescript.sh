...
# # Validar que la entrada contenga solo letras (sin números ni caracteres especiales)
# if [[ ! "$POKEMON_NAME" =~ ^[a-zA-Z-]+$ ]]; then
#     echo "Error: La entrada solo debe contener letras (sin números ni caracteres especiales)."
#     exit 1
# fi
...
# # Imprimir los datos en el formato deseadoy
# echo "$NAME (No. $ID)"
# echo "Id = $ID"
# echo "Weight = $WEIGHT"
# echo "Height = $HEIGHT"
